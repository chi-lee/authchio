...
class Authchio
{
    ...
    addFacebookCookiesStrategy(strategy, appId, appSecret, options)
    {
        ...
        const facebookLinkageManager = new LinkageManager.Facebook();
        const authenticator = new Authenticator.Facebook(this._userManager, sessionManager, facebookLinkageManager);
    }
